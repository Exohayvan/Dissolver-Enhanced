...
public class ValueEMC {
    ...
    public static int set(CommandContext<CommandSourceStack> context, String command) {
    ...
    public static int get(CommandContext<CommandSourceStack> context, String command) {
        ItemStack stack = heldStack(context);
        if (stack.isEmpty()) {
    ...
    public static int clear(CommandContext<CommandSourceStack> context, String command) {
        ItemStack stack = heldStack(context);
        if (stack.isEmpty()) {
    ...
    private static ItemStack heldStack(CommandContext<CommandSourceStack> context) {
