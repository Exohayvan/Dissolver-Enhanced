...
public class ModCommands {
    ...
    public static void init() {
            ...
            .then(literal("value")
                .then(literal("set")
                    .then(argument("amount", StringArgumentType.word())
                        .executes((context) -> executeCommand(context, "value set", ValueEMC::set))))
                .then(literal("get").executes((context) -> executeCommand(context, "value get", ValueEMC::get)))
                .then(literal("clear").executes((context) -> executeCommand(context, "value clear", ValueEMC::clear))))
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> dispatcher.register(
            ...
            .then(createCommandWithPlayerArg("fill", ItemArgument.item(registryAccess), LearnItems::everything, LearnItems::everythingPlayer))
            .then(createCommandWithPlayerArg("clear", ItemArgument.item(registryAccess), LearnItems::forget, LearnItems::forgetPlayer))
