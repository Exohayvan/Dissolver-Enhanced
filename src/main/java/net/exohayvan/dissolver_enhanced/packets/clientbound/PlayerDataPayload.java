...
public record PlayerDataPayload(String emc, int learnedItemsSize, int learnedItemsTotalSize, String message, List<String> learnedItems) implements CustomPayload {
	...
	public static final PacketCodec<RegistryByteBuf, PlayerDataPayload> CODEC = PacketCodec.tuple(
		PacketCodecs.STRING, PlayerDataPayload::emc,
