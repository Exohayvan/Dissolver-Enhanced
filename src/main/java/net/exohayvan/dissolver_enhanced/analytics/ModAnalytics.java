...
public final class ModAnalytics {
    ...
    public static void captureDissolverItemLearned(
        ...
        captureDissolverItem(
            ITEM_LEARNED_EVENT, namespace, item, itemId, stackCount, singleValue, totalValue, creativeItem
        );
    }
    ...
    public static void captureDissolverItemDissolved(
        ...
        captureDissolverItem(
            ITEM_DISSOLVED_EVENT, namespace, item, itemId, stackCount, singleValue, totalValue, creativeItem
        );
    }
    ...
    public static void captureDissolverItemExtracted(
        ...
        captureDissolverItem(
            ITEM_EXTRACTED_EVENT, namespace, item, itemId, stackCount, singleValue, totalValue, creativeItem
        );
    }

    private static void captureDissolverItem(
        String event,
        String namespace,
        String item,
        String itemId,
