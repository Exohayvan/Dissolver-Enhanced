...
public class ModItems {
    ...
    public static final DeferredHolder<Item, Item> CRYSTAL_FRAME_ITEM = ITEMS.register("crystal_frame_item", () -> new CrystalFrameItem(RegistryKeyCompat.itemProperties("crystal_frame_item")));
    public static final DeferredHolder<Item, Item> EMC_ORB = ITEMS.register("emc_orb", () -> new EMCOrbItem(RegistryKeyCompat.itemProperties("emc_orb").stacksTo(1)));
    ...
    private static DeferredHolder<Item, Item> registerEmcCore(String id, int emcPerSecond) {
        return ITEMS.register(id, () -> new EmcCoreItem(RegistryKeyCompat.itemProperties(id).stacksTo(1), emcPerSecond));
    }
