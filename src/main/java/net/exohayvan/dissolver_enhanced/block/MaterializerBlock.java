...
public class MaterializerBlock extends ScreenOpeningBlock {
    ...
    public MaterializerBlock(Settings settings) {
        super(settings, "materializer_block");
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(
        ...
        return world.isClient()
            ? null
            : validateTicker(type, ModBlockEntities.MATERIALIZER_BLOCK_ENTITY, MaterializerBlockEntity::tick);
    }
}
