...
public class ModBlocks {
    ...
    private static Block registerBlock(String id, Block block, BlockItem blockItem) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, new ResourceLocation(DissolverEnhanced.MOD_ID, id), block);
    }

    private static Item registerBlockItem(String namespace, String id, BlockItem blockItem) {
        return Registry.register(BuiltInRegistries.ITEM, new ResourceLocation(namespace, id), blockItem);
    }
