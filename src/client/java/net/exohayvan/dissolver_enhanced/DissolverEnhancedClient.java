...
public class DissolverEnhancedClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		// transparent
		BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DISSOLVER_BLOCK, RenderType.translucent());

		EntityRendererRegistry.register(ModEntities.CRYSTAL_ENTITY, CrystalEntityRenderer::new);

		// particle
		ParticleFactoryRegistry.getInstance().register(ModParticles.CRYSTAL, EndRodParticle.Provider::new);
